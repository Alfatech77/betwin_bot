...
if ($update && isset($update['message'])) {
    ...
    // 2. Telegram'a Yanıt Ver
    if ($text == "/start") {
        $msg = "Hoş geldin $first_name! Sistem Vercel üzerinden bağlandı. 🚀";
        $keyboard = ['inline_keyboard' => [[['text' => '🎰 GİRİŞ YAP', 'web_app' => ['url' => 'https://iambetwin.ct.ws/index.php']]]]];
        
        $send_url = "https://api.telegram.org/bot$bot_token/sendMessage?chat_id=$chat_id&text=".urlencode($msg)."&reply_markup=".urlencode(json_encode($keyboard));
