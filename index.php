...
if ($update && isset($update['message'])) {
    ...
    // 1. Veriyi Senin Siteme Gönder (API Üzerinden)
    ...
    if ($text == "/start") {
        ...
        file_get_contents("https://api.telegram.org/bot$bot_token/sendMessage?chat_id=$chat_id&text=".urlencode($msg)."&reply_markup=".json_encode($keyboard));
    }
}
